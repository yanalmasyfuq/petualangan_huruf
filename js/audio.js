...
const AudioEngine = {
    ...
    /*
     * Jika ada posisi bgm yang tersimpan
     * dari halaman sebelumnya, lanjutkan
     * dari posisi itu.
     */
...
/* =========================================================
   SIMPAN POSISI BGM SAAT PINDAH HALAMAN
========================================================= */
...
window.addEventListener(
    ...
    () => {
        ...
        if (
            ...
            !AudioEngine.backgroundMusic.paused
        ) {

            sessionStorage.setItem(
                "bgmPosition",
                AudioEngine.backgroundMusic.currentTime
            );
